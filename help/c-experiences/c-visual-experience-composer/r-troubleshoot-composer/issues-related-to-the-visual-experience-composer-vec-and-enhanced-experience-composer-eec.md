...
如果您對 A/B 或體驗鎖定目標活動使用可視化體驗撰寫器中的**[!UICONTROL 編輯文字/HTML]**，或對自動個人化或多變數測試活動使用**變更文字/HTML]，以讓文字粗體或斜體，這些樣式可能無法在頁面上套用，或文字會從可視化體驗撰寫器中的頁面消失。[!UICONTROL **這是因為 RTF 格式編輯器套用這些樣式的方式可能會干擾網站標記。
