...
| 共用對象 | [!DNL Adobe Experience Cloud] 解決方案之間可以共用對象。如需範例，請參閱[觀眾](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html)。 |
