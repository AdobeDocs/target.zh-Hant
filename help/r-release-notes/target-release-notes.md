...
| 功能 | 詳細資料 |
| --- | --- |
| Audiences UI重新整理 | 我們使用新技術堆疊逐漸重寫整個 [!DNL Target] UI，以提供改善的效能、縮短發布新功能時所需的維護時間，並改善整個產品的使用者體驗。2020年更新的[管理](/help/administrating-target/administrating-target.md)部分。 「[!UICONTROL 對象]」區段是第二次重新整理主要UI。 |
| ![Premium徽](/help/assets/premium.png) 章Recommendations條件建立和編輯 | 已簡化[!UICONTROL Recommendations條件]建立和編輯工作流程，以簡化選擇正確建議演算法和設定以達成您的目標。 |
