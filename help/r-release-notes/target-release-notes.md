...
此維護版本包含以下針對 [Target Standard/Premium 22.1.2 版本](/help/r-release-notes/release-notes.md)中宣布的新[!UICONTROL 對象] UI 的修復和增強功能，該版本將在未來六週內向所有地區的客戶推出。此修正調整了在 [!DNL Adobe Target Standard/Premium] 中建立的對象功能。
