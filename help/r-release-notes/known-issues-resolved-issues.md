...
已解決從9月15日下午2 [!DNL Adobe Target Premium] :30  開始影響使用者「自動目標」報表的問題。(PDT)至10月6日，上午九點二刻(PDT)。 檢視受影響轉換度量的報表(使用「已檢視頁面 [!UICONTROL 」或「已點按mbox]」選項設定)時，會錯誤報告轉換率。 目前沒有已知的傳送問題。
