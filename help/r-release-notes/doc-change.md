...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 2019 年 10 月 3 日 | [已知問題和已解決的問題](/help/r-release-notes/known-issues-resolved-issues.md) | 已新增使用at.js 2建立體驗而無修改時的已知問題和解決方法。*x資料庫* 。 |
|  | [疑難排解內容傳送](/help/c-activities/c-troubleshooting-activities/content-trouble.md#mboxdebug) | Added note to "mboxDebug" section. |
| 2029 年 10 月 2 日 | [Target 版本說明 (發行前)](/help/r-release-notes/target-release-notes.md) | 已新增有關即將發行的資訊。 |
| 2019 年 10 月 1 日 | [設定檔和變數字彙表](/help/c-target/c-visitor-profile/variables-profiles-parameters-methods.md) | Updated text in the "Customer attributes" section. |
...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 2019 年 9 月 27 日 | [A/B 測試該執行多久?](/help/c-activities/t-test-ab/sample-size-determination.md) | Updated text about the Target Sample Size Calculator. |
|  | [自動分配](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | Updated text about the Target Sample Size Calculator. |
| September 24, 2019 | [Target 版本說明 (發行前)](/help/r-release-notes/target-release-notes.md) | 將Target/Standard 19.2.1發行的日期變更為2019年9月30日。 |
...
|  | [Target for mobile apps FAQ](/help/c-target-mobile-app/target-for-mobile-apps-faq.md) |  新主題。 |
...
| 2019 年 8 月 23 日 | [Target 行動裝置預覽](/help/c-target-mobile-app/target-mobile-preview.md) | 更新中的程式碼片段 `AndroidManifest.xml`。 |
...
| August 20, 2019 | [Target 版本說明 (發行前)](/help/r-release-notes/target-release-notes.md) | 推遲Target/Premium 19.8.1版（2019年8月20日）。 此發行的內容將會轉入19.9.1發行（2019年9月24日）。 |
|  | [設計常見問題集](/help/c-recommendations/c-design-overview/template-faq.md) | 新增下列常見問答：「我建議的項目價格不會在小數點右側顯示兩個值。 我要如何展示？」 |
| 2019 年 8 月 16 日 | [mbox3rdPartyID 的即時設定檔同步](/help/c-target/c-visitor-profile/3rd-party-id.md) | 新增區段："考量。" |
...
| 2019年8月12日 | [Android - 設定行動應用程式](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md#sdk-library) | 已更新相關性和對象的資訊。<br>更新檔案的程式碼 `AndroidManifest.XML` 範例。 |
|  | [Target 版本說明 (最新)](/help/r-release-notes/release-notes.md) | 更新「Target Mobile VEC SDK iOS 2.1.0 &amp; Android 1.1.1」區段中的增強功能和修正清單。 |
|  | [編輯活動或另存為草稿](/help/c-activities/edit-activity.md#classic) | Added new section: "Work with legacy activities created in Recommendations Classic." |
...
| 2019年8月6日 | [Target 版本說明 (最新)](/help/r-release-notes/release-notes.md) | 已新增Target Mobile VEC SDK iOS 2.1.0和Android 1.1.0版的發行說明。 |
|  | [建立條件](/help/c-recommendations/c-algorithms/create-new-algorithm.md#process-time) | 已更新下列章節："預期的條件處理時間。" |
...
| 2019年8月1日 | [Target發行說明（目前）](/help/r-release-notes/release-notes.md) | Added important announcement regarding API support for Enterprise Permissions. |
...
|  | [目錄搜尋](/help/c-recommendations/c-products/catalog-search.md) | Updated text about how the catalog is refreshed. |
|  | [在行動應用程式 中設定點擊追蹤](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | Added information about the Modifications panel that shows elements you have set up for click-tracking. |
...
|  | [行動應用程式可視化體驗撰寫器](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#ts) | Updated the Troubleshooting section to reflect that the character restrictions no longer apply to app names. The restrictions apply to IDs only. |
|  | [動態消息](/help/c-recommendations/c-products/feeds.md#steps) | Added supported FTP server settings to steps. |
...
|  | [活動](/help/c-activities/activities.md) | 強調您無法還原已刪除的活動。作為最佳實務，您可以封存活動，以便視需要取消封存。 |
|  | [從 at.js 1.x 升級為 at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | 移除說明 at.js 2.x 未完全支援 Experience Cloud Debugger 的限制。 |
| 2019 年 6 月 7 日 | [使用 Velocity 自訂設計](/help/c-recommendations/c-design-overview/customizing-a-template.md#default) | 新增章節:「案例: 使用 null 檢查邏輯建立 4x2 預設 Recommendations 設計」。 |
|  | [Adobe Target Standard 和 Premium 的訓練影片](/help/c-intro/target-standard-premium-training-videos.md#tutorials) | 更新全新 Adobe Target 教學課程網站的連結。 |
...
|  | [管理員入門](/help/administrating-target/start-target.md) | 更新整篇文章。 |
|  | [Target 版本說明 (發行前)](/help/r-release-notes/target-release-notes.md) | 新增 Target 19.6.1 版本的初步發行說明。 |
| 2019 年 6 月 5 日 | [行動應用程式可視化體驗撰寫器](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md) | 新增[疑難排解](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#ts)一節。 |
|  | [從 at.js 1.x 升級為 at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | 更新使用 Adobe Launch (這是偏好使用的部署方法) 部署 at.js 的相關資訊。 |
|  | [Target 重要概念](/help/c-intro/target-key-concepts.md) | 次要的文字編輯。 |
| 2019 年 3 月 6 日 | [發行說明 (最新)](/help/r-release-notes/release-notes.md) | 新增即將發行的 at.js 2.1.0 版本的相關資訊。 |
...
|  | [隱私權與一般資料保護規範](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) | 更更新 at.js 2.1.0 中選擇加入支援的相關資訊。 |
| 2019 年 5 月 31 日 | [行動](/help/c-target/c-audiences/c-target-rules/mobile.md) | 新增執行 iOS 12.2 的鎖定目標裝置的相關備註。 |
|  | [計劃和實作 Recommendations](/help/c-recommendations/plan-implement.md) | 更新程式碼範例。 |
| 2019 年 5 月 30 日 | [從 Adobe Experience Cloud 存取 Target](/help/c-intro/target-access-from-mac.md#doc-lang) | 此文件現已推出簡體中文版。 |
|  | [將資料下載為 CSV 檔案](/help/c-reports/downloading-data-in-csv-file.md) | 新增注意事項至匯出訂單詳細資料至 CSV 章節:「Target 報表 UI 中套用的受眾不會繼續存在於下載報表中」。 |
|  | [報表設定](/help/c-reports/c-report-settings/report-settings.md) | 更新螢幕截圖。 |
| 2019 年 5 月 29 日 | [類別相關性](/help/c-target/c-visitor-profile/category-affinity.md) | 更新說明 `user.categoryId` 與 `entity.categoryId` 之間的差異的文字。 |
|  | [從 mbox.js 移轉至 at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/c-target-atjs-implementation/target-atjs-implementation.md) | 重新調整此主題的章節位置: at.js 的優點。 |
|  | [at.js 常見問題](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md) | 重新調整此主題的章節位置:「at.js 和 mbox.js 對頁面載入時間有何影響? 」 |
|  | [將動態資料傳遞至選件](/help/c-experiences/c-manage-content/passing-profile-attributes-to-the-html-offer.md) | 修正過去行為一列中的語法。 |
| 2019 年 5 月 28 日 | [從 Adobe Experience Cloud 存取 Target](/help/c-intro/target-access-from-mac.md#doc-lang) | 新增章節:「變更 Target 產品文件的語言」。 |
|  | [決定獲勝者](/help/c-activities/automated-traffic-allocation/determine-winner.md) | 更新 p 值的相關資訊。 |
|  | [疑難排解可視化體驗撰寫器和增強體驗撰寫器的相關問題](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/issues-related-to-the-visual-experience-composer-vec-and-enhanced-experience-composer-eec.md) | 新增有關 Target 如何處理多重層級 iframe 的疑難排解章節。 |
