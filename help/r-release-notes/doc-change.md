...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 1 月 12 日 | [Adobe Experience Platform Web SDK](/help/c-implementing-target/c-implementing-target-for-client-side-web/aep-web-sdk.md) | 新增教學課程的連結及實作指示 [!DNL Adobe Experience Cloud] 搭配Web SDK。 |
