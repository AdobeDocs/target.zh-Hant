...
|  | [回應 Token](/help/administrating-target/response-tokens.md) | 新增有關搭配[!DNL Adobe Experience Platform Web SDK]使用回應Token的資訊。<br>**注意**:此功能將於未來的Platform Web SDK版本中發行。待定日期。 |
