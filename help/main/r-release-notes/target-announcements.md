...
### 迪克的體育用品：零售業個性化與變化中的格局（2022年5月19日）

瞭解關於大規模擴充個性化程式的最佳做法。 看看迪克的體育用品是怎麼用的 [!DNL Adobe Target] 吸引頂級運動員和品牌。
...
與Shawn Wilkinson（電子商務個人化經理）一起瞭解如何 [!DNL Target] 幫助迪克的體育用品把普通遊客變成返國運動員。
...
### Adobe:個性化行業內幕人士 — 金融服務和保險（2022年5月24日）

瞭解金融服務公司如何支援客戶，並通知客戶使用個性化功能為通貨膨脹模式和投資策略做好準備。
...
### 城市國家銀行：如何在數字優化中實現前1%（2022年5月26日）

查看用於實施跨功能個性化策略的工具包和使用案例。 看看CNB是如何從業內最底層的26%變為最頂層的1% [!DNL Adobe Target]。
...
### Adobe:精準個性化 —  [!DNL Adobe Analytics] 和 [!DNL Target] （2022年6月2日）

瞭解人工智慧如何繼續重新定義消費者期望值，因為機器學習模型和資料洞察力為營銷人員、開發人員和產品擁有者開啟了新的大門，讓消費者獲得重要的個性化體驗。 逐步瞭解 [!DNL Adobe Analytics] + [!DNL Adobe Target] 用於個性化、目標和測試的工作流。
...
### 城市國家銀行：Zero to Hero — 啟動和擴展個性化計畫（2022年6月9日）

學習如何成為「關係銀行」以提高品牌忠誠度的最佳實踐。 瞭解如何推動人員和流程構建和擴展成功的個性化程式。
...
### Adobe:發現影響力巨大的優化機會（2022年6月16日）

瞭解在我們進入前所未有的數字化新常態時，組織必須充分利用每一個機會提供卓越的數字型驗。 好到不能再好了。 要保持競爭力，需要極好的體驗。
...
### Adobe:個性化行業內幕人士 — 零售（2022年6月21日）

2022年為企業提供了動態且瞬息萬變的運營環境。 瞭解行業專家在員工和旅行者的生活開始恢復正常時，如何看到新的消費趨勢正在形成。 
