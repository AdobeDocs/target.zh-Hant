...
| 9 月 19 日 | [目的地指南中的](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}Adobe Target連線[!DNL Adobe Experience Platform]。 | 更新下列備註： *跨組織*&#x200B;的資料流唯一性。 |
...
|  | 在[開發人員指南](https://experienceleague.adobe.com/en/docs/target-dev/developer/recommendations#set-up-your-recommendations-catalog){target=_blank}中&#x200B;*[!DNL Target]計畫和實作Recommendations* | 新增透過[!DNL Recommendations]更新[!UICONTROL Catalogs] [!DNL Target Delivery API]時請務必謹慎的備註。 |
