...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 5 月 22 日 | [整合 [!DNL Real-Time Customer Data Platform]](/help/main/c-integrating-target-with-mac/integrating-with-rtcdp.md#videos-blogs) | 已新增下列新影片: <ul><li>配置 [!DNL Adobe Target] 目標 [!DNL Real-Time Customer Data Platform]</li><li>激活段和配置檔案屬性</li><li>使用 [!DNL Real-Time CDP] 分部 [!DNL Target]</li><li>使用 [!DNL Real-Time CDP] 配置檔案屬性 [!DNL Adobe Target]</li></ul> |
| 5 月 19 日 | [[!DNL Target] 發行說明 (搶鮮版)](/help/main/r-release-notes/target-release-notes.md) | 已更新即將發佈的預發行說明。 |
| 5 月 17 日 | [[!DNL Adobe Target] 公告和活動](/help/main/r-release-notes/target-announcements.md) | 已添加有關 [!UICONTROL Adobe Target社區] 2023年5月24日星期三的問答環節。 |
...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 1 月 13 日 | [Visual Editing Helper 擴充功能](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md) | 已新增「常見問題集」一節。 |
| 1 月 12 日 | [可視化體驗撰寫器協助程式擴充功能](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/vec-helper-browser-extension.md) | 已更新說明最新[!UICONTROL  可視化體驗撰寫器]協助程式擴充功能狀態的重要注意事項。 |
|  | [鎖定目標和對象常見問題](/help/main/c-target/c-troubleshooting-targets-and-audiences/troubleshooting-targets-and-audiences.md) | 已新增說明對象 URL 目標定位和透過 [!UICONTROL  範本規則]新增的 URL 目標定位被評估為 URL 目標定位的資訊。 |
|  | [Target 發行說明 (搶鮮版)](/help/main/r-release-notes/target-release-notes.md) | 已新增 22.13.3 版的搶鮮版注意事項。 |
...
| 11 月 28 日 | 如需詳細資訊，請參閱 [Adobe Target 開發人員指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/administration/models-api/models-api.html)中的{target=_blank}模式 API (加入封鎖清單) 概觀&#x200B;**。 | 新模型 API。<br>[!DNL Target]  有些功能可從機器學習演算法中封鎖，以防止有人將功能用於任何 [!UICONTROL Auto-Target] 或 [!UICONTROL Automated Personalization] 模型或活動。 |
|  | [Target 發行說明 (最新)](/help/main/r-release-notes/release-notes.md) | 新增關於模型 API 版本 (2022 年 11 月 23 日) 的資訊。 |
...
| 10 月 25 日 | [Target 發行說明 (最新)](/help/main/r-release-notes/release-notes.md) | 已新增 [!DNL Target Standard/Premium] 22.10.3 版的發行說明。 |
...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 10 月 3 日 | [Target 發行說明 (搶鮮版)](/help/main/r-release-notes/target-release-notes.md) | 更新 [!DNL Target Standard/Premium] 22.10.1 發行日期。 |
...
|  | [Target 發行說明 (最新)](/help/main/r-release-notes/release-notes.md) | 已新增 [!DNL Target Standard/Premium] 22.9.1 版的發行說明。 |

## Adobe Target Standard/Premium 22.8.1 (分批發行：2022 年 8 月 17 至 18 日)

| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 8 月 22 日 | [[!DNL Adobe Target]  公告和活動](/help/main/r-release-notes/target-announcements.md) | 新增下列公告的資訊：<ul><li>2022 年度 Gartner 個人化引擎的魔力象限報告中將 [!DNL Target] 評為領導者</li></ul>新增下列即將舉行的活動資訊：<ul><li>[!DNL Adobe Target] 社群問答休息時間 (2022 年 8 月 31 日)</li><li>廚師的收藏：個人化配方 (2022 年 8 月 30 日)</li><li>[!DNL Adobe Target] Skill Builders – 行動體驗最佳化 (2022 年 9 月 6 日)</li><li>[!DNL Adobe Target] Skill Builders – AI 驅動的個人化與推薦 (2022 年 9 月 15 日)</li></ul>新增下列先前網路研討會課程的錄製連結：<ul><li>Adobe：個人化的業界內幕 - 零售業 (2022 年 8 月 11 日)</li></ul> |
...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 6 月 30 日 | [Adobe Target 開發人員指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/overview.html){target=_blank} | 推出 *Adobe Target 開發人員指南*，將所有 [!DNL Target] 開發人員內容整合到一個方便的入口網站中。該入口網站包含有關實作 [!DNL Target]和 [!DNL Recommendations]、[!DNL Target] SDK 和 [!DNL Target] API 的資訊。 |
...
| 6 月 14 日 | [計劃和實作 Recommendations](https://experienceleague.corp.adobe.com/docs/target-dev/developer/recommendations.html){target=_blank} | 更新以下部份的程式碼範例：<ul><li>購物卡新增/購物卡檢視/結帳頁面</li><li>排除已經在訪客購物車中的項目</li></ul> |
...
|  | [at.js 版本詳細資料](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank} | 已新增關於 at.js 2.9.0 版的資訊。 |
|  | [使用者代理和用戶端提示](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/user-agent-and-client-hints.html){target=_blank}。  | 新主題。 |
...
| 4 月 28 日 | [企業使用者權限](/help/main/administrating-target/c-user-management/property-channel/property-channel.md#move-audience) | 新增下列常見問題：<ul><li>我能否將對象從一個工作區移動至另一個工作區？</li></ul> |
...
| 3 月 7 日 | [建立對象](/help/main/c-target/c-audiences/audiences.md#aep) | 在「使用來自 [!DNL Adobe Experience Platform] 的對象」底下新增一節：<ul><li>Personalization 使用案例</li></ul> |
...
| 2 月 10 日 | [可視化體驗撰寫器協助程式擴充功能](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/vec-helper-browser-extension.md) | 已新增在可視化體驗撰寫器 (VEC) 中載入使用 Service Worker 的網站的相關資訊。 |
...
|  | [at.js 版本詳細資料](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank}。  | 已新增關於 at.js 2.8.1 版的資訊。 |
...
| 1 月 26 日 | [Target 發行說明 (最新)](/help/main/r-release-notes/release-notes.md) | 已新增關於 [!DNL Target Standard/Premium] 22.1.2 版的資訊。 |
...
| 1 月 21 日 | [at.js 版本詳細資料](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank}。  | 已新增關於 at.js 1.8.3 版的資訊。 |
| 1 月 19 日 | [從 at.js 1.*x* 升級為 at.js 2.*x*](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank} | 已新增下列章節：「at.js 2.*x* 不支援使用 vst.* 參數來建立對象」 |
| 1 月 12 日 | [Target 發行說明 (最新)](/help/main/r-release-notes/release-notes.md) | 已新增關於 [!DNL Target Standard/Premium] 22.1.1 版的資訊。 |
|  | [Adobe Experience Platform Web SDK](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/aep-web-sdk.html){target=_blank} | 已新增教學課程的連結，其中包括如何使用 Web SDK 來實作 [!DNL Adobe Experience Cloud] 的說明。 |
