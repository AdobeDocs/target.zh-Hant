...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 12 月 21 日 | [使用 Velocity 自訂設計](/help/main/c-recommendations/c-design-overview/customizing-a-template.md) | 釐清傳送至的實體屬性 [!DNL Recommendations] 在 `productPage` mbox或CSV上傳可在設計中顯示，但「多值」屬性除外。 |
