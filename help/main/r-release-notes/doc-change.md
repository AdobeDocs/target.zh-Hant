...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 12 月 14 日 | [報表設定](/help/main/c-reports/c-report-settings/report-settings.md#environment) | 在「環境」區段下新增有關使用 [!DNL Adobe Experience Platform] (AEP)將量度資料傳送至 [!DNL Target]. |
