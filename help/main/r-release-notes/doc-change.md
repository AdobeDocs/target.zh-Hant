...
| 日期 | 主題 | 變更 |
|--- |--- |--- |
| 6 月 12 日 | [[!DNL Target] UI更新常見問題](/help/main/c-intro/updated-ui-faq.md) | 新文章。<P>此常見問題集說明有關新[!DNL Target] UI和[!UICONTROL Visual Experience Composer] (VEC)的常見問題，包括導覽變更、功能位置以及暫時性UI版本切換的淘汰。 無論您是行銷人員、開發人員或管理員，此FAQ可協助您順利轉換，並充分運用更新後的UI。 |
