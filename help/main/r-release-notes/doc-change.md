...
|  | [開發人員指南](https://experienceleague.adobe.com/en/docs/target-dev/developer/api/delivery-api/known-limitations){target=_blank}中的&#x200B;*[!DNL Target]考量和已知限制* | 新增透過[!DNL Recommendations]更新[!UICONTROL Catalogs] [!DNL Target Delivery API]時請務必謹慎使用的資訊。 |
