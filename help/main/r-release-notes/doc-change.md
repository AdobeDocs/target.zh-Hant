...
source-git-commit: ea99439e9aec1f09c8c3b436175366f4d968fd91
workflow-type: tm+mt
...
|  | [開發人員指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank}中的&#x200B;*[!DNL Target]傳送API概觀* | 新增透過[!DNL Recommendations]更新[!UICONTROL Catalogs] [!DNL Target Delivery API]時請務必謹慎使用的資訊。 |
