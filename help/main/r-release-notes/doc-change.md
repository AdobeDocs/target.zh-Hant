...
| 日期 | 主題 | 變更 |
|--- |--- |--- |
| 9 月 19 日 | [目的地指南中的](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}Adobe Target連線[!DNL Adobe Experience]。 | 更新下列備註： *跨組織*&#x200B;的資料流唯一性。 |
