...
1. 在[基本資訊](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#info)區段中填入資訊。
   ...
   1. 從&#x200B;**[!UICONTROL 選取演演算法]**&#x200B;型別下拉式清單中，選取&#x200B;**[!UICONTROL 自訂條件]**。

   1. 從&#x200B;**[!UICONTROL 演演算法]**&#x200B;下拉式清單中，選取&#x200B;**[!UICONTROL 自訂演演算法]**。

      >[!NOTE]
      >
      >上述步驟會使[!UICONTROL 上傳CSV]區段顯示在[!UICONTROL 建立新條件]對話方塊的底部。
...
* 自訂條件摘要每 24 小時會更新一次。
  ...
  您可以在[!UICONTROL Recommendations] > [!UICONTROL 條件]頁面上的每個條件卡底部，看到自訂條件上傳的上傳和同步狀態。 編輯自訂條件時，您也可以在[!UICONTROL 編輯]對話方塊中檢視狀態。
