...
description: 了解如何設定用來說明和控制Adobe Target中Recommendations活動的設定。
...
可用來說明和控制 [!UICONTROL Recommendations] 活動 [!DNL Adobe Target].
...
如果指定已存在 [!UICONTROL Recommendations Classic] 另一個活動中的 [!UICONTROL Recommendations] 活動名稱，則會將新活動重新同步為新名稱。新名稱為原始名稱附加時間戳記的唯一名稱。新名稱會顯示在兩者中 [!DNL Target Standard/Premium] 和 [!UICONTROL Recommendations Classic].
...
* **報表來源：** 選取報表來源： [!DNL Adobe Target] 或 [Analytics](/help/main/c-integrating-target-with-mac/a4t/a4t.md). 活動上線後，請勿變更報表來源。在活動上線後變更報表來源會導致不一致的報表。
