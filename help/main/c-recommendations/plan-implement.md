...
如需詳細資訊和逐步指示，請參閱&#x200B;*Adobe Target開發人員指南*&#x200B;入口網站中的[計畫和實作Recommendations](https://experienceleague.adobe.com/docs/target-dev/developer/recommendations.html){target=_blank}。
