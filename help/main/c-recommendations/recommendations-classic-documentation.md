...
推薦有助於將客戶導向他們原本可能不知道的項目，提升網站產生的銷售額。

如需可協助您在[!DNL Recommendations Classic]中的[!DNL Recommendations]與[!DNL Target Premium]個活動之間進行選擇的資訊，請參閱Target Premium中的[Recommendations Classic與Recommendations活動的比較](/help/main/c-recommendations/c-recommendations-faq/recommendations-classic-versus-recommendations-activities-target-premium.md)。
