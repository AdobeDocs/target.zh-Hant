...
1. 按一下 **[!UICONTROL 活動]** 和 [建立新的Recommendations](/help/main/c-recommendations/t-create-recs-activity/create-recs-activity.md) 活動或編輯現有活動。

1. 選取條件和設計後， [!UICONTROL 選項] 頁面會在您選取所需集合時顯示。
