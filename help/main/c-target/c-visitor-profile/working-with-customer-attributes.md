...
* 在[!DNL People]服務中使用[!UICONTROL Customer Attributes]功能之前，您必須符合一些先決條件要求。 如需詳細資訊，請參閱&#x200B;*Experience Cloud介面與管理*&#x200B;指南中[客戶屬性](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html#section_BD38693AFBF34926BA28E964963B4EA0)的「上傳客戶屬性的先決條件」。
...
您可以在&#x200B;*Experience Cloud介面與管理*&#x200B;指南中的[建立客戶屬性來源及上傳資料檔案](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html)中找到完成下列各工作的詳細指示。
