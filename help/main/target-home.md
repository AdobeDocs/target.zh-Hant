...
- [[!UICONTROL Adobe Target開發人員指南]](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html){target=_blank}：本指南為[!DNL Adobe Target]名開發人員提供資源和指南，包括實施[!DNL Target]的API和SDK檔案。
