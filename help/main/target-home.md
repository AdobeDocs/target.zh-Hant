...
**上次更新日期：2022 年 5 月 11 日 ([查看變更內容](r-release-notes/doc-change.md))**
...
- [疑難排解 Target](r-troubleshooting-target/troubleshooting-target.md)：提供本指南中疑難排解資訊的連結，包括會對 [!DNL Target] 中的活動和其他元素造成影響的角色限制和其他限制 (選件大小、對象、個人資料、值、參數等) 相關資訊。
...
- [Target Adobe.IO 文件](https://developers.adobetarget.com/api/#introduction)：說明如何使用 Target 的管理程式和個人資料 REST API，其用 Adobe.IO 整合來管理活動、對象、選件、性質、報告、mboxes、環境和個人資料。
