...
**上次更新日期：2025年6月12日（[檢視變更內容](r-release-notes/doc-change.md) ）**
...
自2025年5月27日起，所有客戶都能存取新的[!DNL Target] UI。 自2025年6月22日起，UI切換將會移除，所有使用者將永久轉換為更新的UI，沒有回覆的選項。

[![深入瞭解圖示](/help/main/assets/learn-more.svg)](/help/main/r-release-notes/release-notes.md#toggle)

>[!TAB 新功能]

**[!DNL Target]UI更新常見問題集**

此更新於2025年6月6日發行，包含全新的UI改良和重要說明檔案增強功能。 此常見問題集說明有關新[!DNL Target] UI和[!UICONTROL Visual Experience Composer] (VEC)的常見問題，包括導覽變更、功能位置以及暫時性UI版本切換的淘汰。 無論您是行銷人員、開發人員或管理員，此FAQ可協助您順利轉換，並充分運用更新後的UI。
