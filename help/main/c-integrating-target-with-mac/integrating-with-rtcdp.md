...
* [對邊緣個人化目的地啟用對象](https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/activate/activate-edge-personalization-destinations.htm){target=_blank} (在&#x200B;*目的地概觀*&#x200B;指南中)。
