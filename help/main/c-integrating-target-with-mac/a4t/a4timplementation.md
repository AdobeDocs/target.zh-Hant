...
請參閱&#x200B;*Experience Cloud訪客ID服務*&#x200B;檔案中的[實作Experience Cloud ID服務（適用於Target）](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html)。
