...
1. 在&#x200B;**[!UICONTROL Admin Console]**&#x200B;中，按一下[!DNL Analytics]產品設定檔，然後按一下「**[!UICONTROL 許可權]**」標籤。
...
1. 設定[!UICONTROL Web服務存取]群組的存取權。

   必須存取[!DNL Analytics]中的[!UICONTROL Web服務存取]群組，才能使用[!DNL Analytics]做為[!DNL Target]的報告來源。
