...
使用at.js 1.6.3或更高版本時，計算兩個頁面上的頁面視圖不是問題。 此競爭條件只會影響使用舊版本的客戶。Target 團隊會維護兩個版本的 at.js: 最新版本和次新版本。根據需要升級at.js以確保您正在運行 [支援的版本](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/){target=_blank}。
