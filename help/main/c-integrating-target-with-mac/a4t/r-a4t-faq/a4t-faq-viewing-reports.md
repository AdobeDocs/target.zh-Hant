...
如需詳細資訊，請參閱[Adobe Target教學課程](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-target-activities.html)中的&#x200B;*如何在Analysis Workspace中為自動鎖定目標活動設定A4T報告*。
...
如需詳細資訊，請參閱[Analytics管理指南](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/conversion-variables/conversion-var-admin.html)中的&#x200B;*轉換變數(eVar*)。
