...
填寫[Marketing Cloud整合布建表單](https://survey.adobe.com/jfe/form/SV_ekBHTLSoP5Zki2y){target=_blank}時，請注意下列有關「[!UICONTROL For which capabilities are you requesting provisioning]」底下所列[!UICONTROL Shared Audiences]選項的重要資訊？
