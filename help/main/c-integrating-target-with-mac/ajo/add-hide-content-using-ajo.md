...
>[!MORELIKETHIS]
>
>在&#x200B;*Journey Optimizer檔案中[使用網頁設計工具](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channels/web/author-web-pages/web-visual-editor){target=_blank}*
