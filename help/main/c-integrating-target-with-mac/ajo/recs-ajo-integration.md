...
* 使用[[!DNL Adobe Target Premium]](/help/main/c-intro/intro.md#premium)Adobe Experience Platform Web SDK[實作的](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/aep/aep-web-sdk-overview){target=_blank}。
