...
* 若要使用此整合，慣用的實作方法是透過[[!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/en/docs/experience-platform){target=_blank}實作[!DNL Target][[!DNL Adobe Experience Platform Web SDK]和](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/aep/aep-web-sdk-overview){target=_blank}。
