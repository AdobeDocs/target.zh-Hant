...
* 如需關於時間的任何問題，請參閱[指南](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-overview/cja-faq#latency){target=_blank}中&#x200B;*常見問題*&#x200B;的&#x200B;*[!DNL Adobe Customer Analytics]延遲考量事項*。
...
1. 設定您的事件資料集。
   ...
   如需詳細資訊，請參閱[指南](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-connections/create-connection#add-dataset){target=_blank}中&#x200B;*建立連線*&#x200B;中的&#x200B;*[!DNL Adobe Customer Journey Analytics]新增並設定資料集*。
...
1. 設定資料檢視，並確認其指向到您上方所建立的連線。
   ...
   如需詳細資訊，請參閱[指南](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-dataviews/create-dataview){target=_blank}中的&#x200B;*[!DNL Adobe Customer Journey Analytics]建立或編輯資料檢視*。
...
1. 在[!DNL Customer Journey Analytics]中，建立Experimentation面板，然後從&#x200B;**[!UICONTROL Experiment]**&#x200B;下拉式功能表中選取活動。
   ...
   如需詳細資訊，請參閱[指南中](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-workspace/panels/experimentation?lang=en#use){target=_blank}實驗面板&#x200B;*下的*&#x200B;實驗面板&#x200B;*[!DNL Customer Journey Analytics]*。
...
1. 按一下 **[!UICONTROL Build]**。
   ...
   [!UICONTROL Experimentation]面板會傳回一組豐富的資料和視覺效果，協助您更清楚瞭解實驗的執行情況。 如需詳細資訊，請參閱[[!UICONTROL Panel output]指南中](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-workspace/panels/experimentation#panel-output){target=_blank}實驗面板&#x200B;*下的**[!DNL Customer Journey Analytics]*。
