...
1. 使用在上一步中取得的實作程式碼更新您的[!DNL Target]實作。
   ...
   * 透過&#x200B;**內標籤中的「自訂引數」[!DNL Adobe Experience Platform]：**
     ...
     如需詳細資訊，請參閱[標籤總覽](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/target/overview.html?lang=zh-Hant#add-mbox-params)檔案中的&#x200B;*新增Mbox引數*。
