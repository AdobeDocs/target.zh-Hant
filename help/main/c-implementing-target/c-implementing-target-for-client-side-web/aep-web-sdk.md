...
| [TLS（傳輸層安全性）加密更改](https://developer.adobe.com/target/before-implement/tls-transport-layer-security-encryption/){target=_blank} | TLS（傳輸層安全性）{target=_blank}可幫助您維護最高的安全標準並提升客戶資料的安全性。 |
