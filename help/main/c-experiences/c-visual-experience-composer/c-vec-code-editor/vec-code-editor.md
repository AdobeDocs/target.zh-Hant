...
[!UICONTROL Modifications]頁面會顯示VEC中對您的頁面所做的所有變更。 您所做的每項變更都會在[!UICONTROL Modifications]清單中顯示為個別的動作或元素。
...
* 編輯現有動作。 暫留在所需的修改上，然後按一下&#x200B;**[!UICONTROL Edit]**&#x200B;圖示。
...
* 刪除現有動作。 暫留在所需的修改上，然後按一下&#x200B;**[!UICONTROL Delete]**&#x200B;圖示。

  ![codeditor_delete影像](assets/codeditor_delete.png)

* 新增修改。 按一下&#x200B;**[!UICONTROL Add Modification]**&#x200B;或+圖示，然後指定您的變更，如下所述。

  ![codeeditor_new image](assets/codeeditor_new.png)

  請注意，建立修改後，Target 會在「修改」面板的頂部顯示一個 + 圖示，而不是在面板底部顯示「新增修改」按鈕。

* 沿著 Target UI 的側邊垂直固定「修改」面板，或水平固定在底部。 按一下[!UICONTROL Dock]圖示，在兩個設定之間切換。
...
1. 若要顯示所選取體驗的[!UICONTROL Modifications]頁面，請在VEC中按一下&#x200B;**[!UICONTROL Modifications]** &lt;/>圖示。
   ...
   體驗B會在右側的[!UICONTROL Modifications]面板中顯示先前的修改。
...
1. 從&#x200B;**[!UICONTROL Modifications Type]**&#x200B;下拉式清單中，選擇所要的型別：
...
**[!UICONTROL Custom Code]**&#x200B;面板包含在頁面載入開始時執行的程式碼。
