...
[!DNL Adobe Target]中[!UICONTROL 活動概覽]頁面上的[!UICONTROL 衝突]索引標籤會列出您網站上的活動衝突。

有多個活動設定成在相同頁面上提供內容時，就會發生活動衝突。 如果發生活動衝突，您可能無法在頁面上看到預期的內容。

活動概觀頁面上提供[!UICONTROL 衝突]索引標籤，如果您的活動包含潛在衝突，此索引標籤會通知您。

若要存取[!UICONTROL 衝突]索引標籤，請按一下&#x200B;**[!UICONTROL 活動]** >從清單按一下需要的活動>然後按一下左側邊欄中的&#x200B;**[!UICONTROL 衝突]**。
...
[!UICONTROL 衝突]清單會顯示每個使用mbox且使用相同URL的[!DNL Target]案例。 對於每個潛在衝突，清單會顯示活動URL、可能發生衝突的mbox名稱，以及任何符合這兩個條件的活動。 如果有多個 Mbox，則每個皆會列出。
