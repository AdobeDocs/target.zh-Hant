...
description: 瞭解如何在AdobeSPA中使用VEC [!DNL Target] 建立test並以獨SPA立的方式個性化內容，而不依賴於持續的開發。
...
* 已更改「產品」視圖中的按鈕顏色，該視圖位於URL下： [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products)。

考慮到上面的示例，配置 [!UICONTROL 頁面傳遞] 設定僅包括： [https://target.enablementadobe.com/react/demo/#/](https://target.enablementadobe.com/react/demo/#/) 和SPAat.js 2。*x* 的 SPA 中)，那麼會發生什麼情況?
...
* 用戶直接導航到 [https://target.enablementadobe.com/react/demo/#/](https://target.enablementadobe.com/react/demo/#/)。
...
注：用戶導航到 [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products) 未觸發頁載入。

**第 2 個使用者旅程**

* 用戶直接導航到 [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products)。
...
* 沒有符合條件的活動 [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products)。
