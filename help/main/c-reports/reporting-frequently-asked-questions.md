...
XT 活動應一律都有控制體驗。 如果您使用XT活動的方式類似於[!UICONTROL A/B測試]活動（這是相當常見的案例），控制體驗資料會很實用。 如果您發現控制體驗資料在您的報表中並不實用，您可以將其忽略。
...
1. 從&#x200B;**[!UICONTROL 控制]**&#x200B;下拉式清單中，選取接收流量的體驗。

1. 按一下&#x200B;**[!UICONTROL 「儲存」]**。

>[!NOTE]
>
>如需有關如何更新[!UICONTROL Automated Personalization] (AP)活動以及將控制體驗變更為接收流量的體驗的詳細資訊，請參閱[選取Automated Personalization或自動鎖定目標活動的控制](/help/main/c-activities/t-automated-personalization/experience-as-control.md)。
...
* 如果您在[!DNL Target]或[!DNL Analytics]，而且您使用&#x200B;**[!UICONTROL 造訪]**&#x200B;量度，請記住[!DNL Target]是以訪客為基礎的系統，且A/B或MVT測試的流量分佈是在訪客層級指派。 因此，如果您使用&#x200B;**[!UICONTROL 造訪]**&#x200B;量度來檢查活動結果，流量分佈可能會顯得不平均，因為某些訪客可能有多次造訪。 訪客是評估活動績效時的標準標準化量度。
