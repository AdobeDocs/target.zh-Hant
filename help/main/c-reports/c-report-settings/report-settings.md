...
1. 在&#x200B;**[!UICONTROL Target預設集]**&#x200B;旁邊，按一下&#x200B;**[!UICONTROL 更多選項]** （![更多選項圖示](/help/main/assets/icons/MoreSmallListVert.svg) ）圖示> **[!UICONTROL 另存新檔]**。

   [!UICONTROL 建立預設集]對話方塊隨即顯示。

   ![新預設集對話方塊](/help/main/c-reports/c-report-settings/assets/report_preset_dialog-new.png)

1. 檢閱&#x200B;**[!UICONTROL 篩選器]**&#x200B;區段中的資訊，以確保根據需要設定報表，然後指定&#x200B;**[!UICONTROL 預設集名稱]** （最多50個字元）。
1. （視條件而定）如果您希望將此作為預設/我的最愛報表檢視，請滑動「**[!UICONTROL 設定為預設的預設集]**」切換至「開啟」位置。
1. 按一下&#x200B;**[!UICONTROL 建立]**。
...
1. 視需要編輯報表設定 (量度、日期範圍、對象、進階設定等)。
   ...
   在編輯報表的設定後按一下「[!UICONTROL 儲存]」，預設集名稱后面會顯示一個星號( &#42;)，表示預設集已變更。

1. 按一下&#x200B;**[!UICONTROL 更多選項]** （![更多選項圖示](/help/main/assets/icons/MoreSmallListVert.svg) ）圖示> **[!UICONTROL 另存新檔]**&#x200B;以建立新的預設集。

### 刪除預設集

1. 選取要刪除的預設集。
1. 按一下&#x200B;**[!UICONTROL 更多選項]** （![更多選項圖示](/help/main/assets/icons/MoreSmallListVert.svg) ）圖示> **[!UICONTROL 刪除]**。

1. 再按一下&#x200B;**[!UICONTROL 刪除]**&#x200B;以確認您的刪除（已刪除的預設集無法復原）。
...
## [!UICONTROL 報表量度] {#section_894ABD7148244806B7CE556EBBA2AD62}

按一下&#x200B;**[!UICONTROL 報表量度]**&#x200B;下拉式清單，選取其他[成功量度](/help/main/c-activities/r-success-metrics/success-metrics.md#reference_D011575C85DA48E989A244593D9B9924)或多個量度以顯示於圖表中。
...
## [!UICONTROL 客群] {#section_70926EB4618945D9AFF2B0564FF3717B}
...
按一下&#x200B;**[!UICONTROL 預設日期範圍]**&#x200B;下拉式清單，從預設日期範圍中選擇。

為報表選取新的&#x200B;**[!UICONTROL 「開始」]**&#x200B;和&#x200B;**[!UICONTROL 「結束」]**&#x200B;日期。 您也可以使用&#x200B;**[!UICONTROL 活動開始]**&#x200B;和&#x200B;**[!UICONTROL 活動開始 — 活動結束]**&#x200B;範圍。
...
[!UICONTROL 日期範圍]方塊會顯示報表目前的日期範圍。 按一下「**[!UICONTROL 行事曆]**」（「![行事曆」圖示](/help/main/assets/icons/Calendar.svg)）圖示，以顯示可讓您變更報表日期範圍的行事曆。

## 設定 {#section_D99CE462107D45CABE0960F820E1E972}

若要設定報表設定：

1. 按一下&#x200B;**[!UICONTROL 報表設定]** （![報表設定圖示](/help/main/assets/icons/Setting.svg) ）圖示，進行所需的變更（如下所述）。
...
按一下[!UICONTROL 重設報表資料]。 重設報表資料以移除舊資料。 目前的訪客會保留在活動中。  此選項僅適用於具有[!UICONTROL 核准者]許可權的使用者。
...
[!UICONTROL 排除極端值]切換適用於具有收入和參與量度型別的活動。 如需詳細資訊，請參閱[排除極端訂單](/help/main/c-reports/c-report-settings/excluding-extreme-orders.md#task_2AE7743FFCDD466DAEEB720BE5F33DAA)。

## 下載 {#section_77E65C50BAAF4AB79242DB3A8778ADEF}

按一下「**[!UICONTROL 下載]**」（「![下載」圖示](/help/main/assets/icons/Download.svg)）圖示，即可下載[!DNL .csv]格式的報表資料，以快速匯入至Excel、Access或其他資料分析程式。
...
按一下「**[!UICONTROL 重新整理]**」（「![重新整理」圖示](/help/main/assets/icons/Refresh.svg)）圖示，重新整理報表的表格和圖形檢視，而不重新整理整個頁面、其設定或其日期範圍。

## 更多選項 {#section_AB1B5C695D7045A0A0AC0E2698D2E7DE}

按一下&#x200B;**[!UICONTROL 更多選項]**&#x200B;圖示（![更多選項圖示](/help/main/assets/icons/MoreSmallListVert.svg)）以存取[!UICONTROL 另存新檔]和[!UICONTROL 刪除]選項。

## 檢視選項

您可以根據活動型別，以各種格式檢視報表。 選取所需的選項。

* **表格檢視**：按一下&#x200B;**[!UICONTROL 表格檢視]** （![表格檢檢視示](/help/main/assets/icons/Table.svg)）圖示，以表格形式檢視報表。
* **圖形檢視**：按一下&#x200B;**[!UICONTROL 圖形檢視]** （![圖形檢檢視示](/help/main/assets/icons/GraphTrend.svg) ）圖示，以圖形形式檢視報表。
* **自動化區段**：(僅適用於[!UICONTROL Automated Personalization] (AP)和[!UICONTROL 自動鎖定目標] (AT)活動。) 按一下**[!UICONTROL 自動化區段] （![自動化區段圖示](/help/main/assets/icons/AutomatedSegment.svg) ）圖示，以檢視[自動化區段報表](/help/main/c-reports/c-personalization-insights-reports/automated-segments-report.md)。
* **重要屬性**： (僅適用於[!DNL Automated Personalization] (AP)和[!UICONTROL 自動鎖定目標] (AT)活動。) 按一下&#x200B;**[!UICONTROL 重要屬性]** （![重要屬性圖示](/help/main/assets/icons/ViewList.svg) ）圖示以檢視[重要屬性報表](/help/main/c-reports/c-personalization-insights-reports/important-attributes-report.md)。
...
按一下[[!UICONTROL 位置貢獻]](/help/main/c-reports/multivariate-test-reports/location-contribution-report.md) （ ![位置貢獻圖示](/help/main/assets/icons/LocationContribution.svg) ）圖示，將報表切換為依位置顯示多變數測試(MVT)活動的貢獻。

## 體驗 {#section_3A450DE1FA7E43F0AAB73165EC3D1C34}

僅在[!UICONTROL 圖表檢視]中檢視報表時可用。
...
若要存取[!UICONTROL 計數方法]選項，在以圖表模式檢視報表時，請按一下&#x200B;**[!UICONTROL 我的主要目標]**&#x200B;下拉式清單，然後選取計數方法。

此計數方法與上述[!UICONTROL 「設定」]對話方塊中選取的方法相同。

依預設會以[!UICONTROL 「每日」]模式繪製圖表。

您可以按一下[!UICONTROL 每日]下拉式清單，然後選取累積選項，以變更模式。

>[!NOTE]
>
>此下拉式清單的名稱會依選取的模式而不同。

[!UICONTROL 自動鎖定目標]活動有四種模式： [!UICONTROL 每日控制]、[!UICONTROL 每日目標]、[!UICONTROL 累積控制]以及[!UICONTROL 累積目標]。

圖表的預設繪製順序如下:

* **[!UICONTROL A/B測試] （包括[!UICONTROL 自動分配]和[!UICONTROL Automated Personalization]）**：建立體驗的順序（以降序排列）。
* **[!UICONTROL 體驗鎖定目標] (XT)**：活動中的體驗順序。
* **[!UICONTROL 多變數測試] (MVT)**：依體驗名稱的字母順序。
* **[!UICONTROL Recommendations]**：體驗建立的順序（以降序排列）。

當您使用[!UICONTROL 計數方法]選項時，請考慮下列警告：

* 針對[[!UICONTROL 自動鎖定目標]活動](/help/main/c-activities/auto-target/auto-target-to-optimize.md)，沒有選項可選取「訪客」作為計數方法。 [!UICONTROL 自動鎖定目標]是唯一您無法由訪客繪製的活動型別。
