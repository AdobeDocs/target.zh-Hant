...
1. 在[[!DNL Target] [!UICONTROL 視覺化體驗撰寫器]](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md) (VEC)中，按一下VEC UI右側邊欄中的&#x200B;**[!UICONTROL 顯示內容小幫手]** （ ![顯示內容小幫手圖示](/help/main/assets/icons/MagicWand.svg) ）圖示。
...
1. 在&#x200B;**[!UICONTROL 提示]**&#x200B;方塊中，說明您要產生的文字。
...
1. 按一下&#x200B;**[!UICONTROL 文字設定]**&#x200B;圖示以指定文字的語調和通訊策略。

   * **通訊策略**：選擇最適合您產生文字的通訊樣式。

     選項包括：[!UICONTROL 無]、[!UICONTROL 緊急]、[!UICONTROL FOMO] （害怕遺失）、[!UICONTROL 社交證明]、[!UICONTROL 稀缺]、[!UICONTROL 獎勵]、[!UICONTROL 排他性]、[!UICONTROL 遊戲化]、[!UICONTROL 資訊]以及[!UICONTROL 教育與見解]。
   ...
   * **音調**：文字的音調應該會與您的對象產生共鳴。 無論您是要提供資訊、令人興奮、好玩或具有說服力，[!DNL AI Assistant]都可以據以調整訊息。
     ...
     選項包括：[!UICONTROL 無]、[!UICONTROL 專業]、[!UICONTROL 同理心]、[!UICONTROL 幽默]、[!UICONTROL 興奮]、[!UICONTROL 勵志]、[!UICONTROL 有說服力]、[!UICONTROL 友善]、[!UICONTROL 正式]、[!UICONTROL 道歉]、[!UICONTROL 自信]、[!UICONTROL 故事故事正在告知]和[!UICONTROL 對話]。
...
1. 按一下&#x200B;**[!UICONTROL 套用]**&#x200B;以選取所需的文字變化。

   您也可以按一下&#x200B;**[!UICONTROL 預覽]**&#x200B;以檢視不同的變化。 按一下所需的變數，然後按一下&#x200B;**[!UICONTROL 選取]**。

   產生文字的![AI小幫手](/help/main/c-intro/assets/ai-text-done.png)

1. （視條件而定）按一下[!UICONTROL 復原]圖示（ ![復原圖示](/help/main/assets/icons/Undo.svg)）以復原變更。
...
1. （選用）提供意見回饋給[!DNL AI Assistant]。
   ...
   * 按一下[!UICONTROL 報告結果] （![報告結果圖示](/help/main/assets/icons/Flag.svg) ）圖示，向[!DNL AI Assistant]報告問題。
...
**[!UICONTROL 提示]**：撰寫三天的紐約之旅吸引人的廣告，以造訪熱門目的地。
**[!UICONTROL 文字設定]**： FOMO、英文、有說服力、Medium長度。
* **[!UICONTROL Variation 1]**：獨家三日遊，讓您盡情探索NYC的魔力！ 您可以盡情體驗時代廣場、中央公園和自由女神像等標誌性景點。 加入無數體驗過這座永不沈睡的城市刺激與美景的人們。 不要錯過難忘的記憶。 請立即預訂您的冒險活動，盡情享受精彩生活！ 可用的位置有限！
* **[!UICONTROL Variation 2]**：使用我們專屬的三天休假來探索NYC的魔力！ 您可以參觀時代廣場和中央公園等標誌性建築，盡情享受世界級的餐飲和娛樂。 不要錯過這次難忘的冒險。 空間有限，每個人都對自己的絕佳體驗讚不絕口。 立即預約，參與吸引全球旅客的精彩活動！
* **[!UICONTROL 變數3]**：開始令人興奮的三天逃亡到NYC，那裡有標誌性的地標等待著！ 探索時代廣場的電氣氣氛，享受曼哈頓美食佳餚，從帝國大廈欣賞壯麗的景色。 立即行動，加入無數冒險家們的夢想。 不要錯過在城市中建立永不沈睡的難忘回憶。 可用的位置有限。 立即預約您的冒險之旅！
* **[!UICONTROL 變數4]**：立即預訂三天的NYC歷險，體驗前所未有的城市魔力！ 從標誌性的景點到隱藏的寶石，Apple的每一個角落都有令人興奮的東西。 不要錯過其他人已經享受的難忘時刻。 成為熱門話題的一部分。 保護您當下的位置，並創造永恆的回憶。 快點，空間快滿了！
