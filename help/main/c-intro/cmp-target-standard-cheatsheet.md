...
如需更多詳細資訊，請參閱[支援的瀏覽器](https://developer.adobe.com/target/before-implement/supported-browsers/)矩陣。{target=_blank}請注意，有以下兩個方面：Target Standard/Premium Experience Cloud 介面支援與桌面/裝置上的使用者瀏覽器支援。
...
若要在行動裝置上最佳化和個人化，您需要使用 [表單式活動](/help/main/c-experiences/form-experience-composer.md#task_FAC842A6535045B68B4C1AD3E657E56E) 以及 [AdobeSDK](https://developer.adobe.com/target/implement/mobile/enable-target-in-sdk/){target=_blank}. Check out more details about [Target for mobile apps](https://developer.adobe.com/target/implement/mobile/){target=_blank}.
