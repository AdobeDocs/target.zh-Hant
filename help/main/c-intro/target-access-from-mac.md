...
description: 瞭解如何從Adobe Experience Cloud存取 [!DNL Target] 、設定您的預設組織，以及變更 [!DNL Target] 使用者介面和檔案的語言。
...
1. 按一下導覽列中的&#x200B;**[!UICONTROL 應用程式圖示]**，然後按一下&#x200B;**[!UICONTROL 目標]**。
...
1. （選擇性）若要在您登入[!DNL Experience Cloud]時設定預設組織，請按一下您的設定檔頭像下的&#x200B;**[!UICONTROL 偏好設定]**，然後設定您的預設組織。

   ![登陸頁面](/help/main/c-intro/assets/pagepref-new.png)

## 變更[!DNL Target] UI的預設語言 {#language}

1. 登入[!DNL Adobe Experience Cloud]或[!DNL Target]後，請按一下您的設定檔頭像，然後按一下&#x200B;**[!UICONTROL 偏好設定]**。

1. 按一下&#x200B;**[!UICONTROL Adobe帳戶]**&#x200B;以存取您的[!DNL Adobe]設定檔。

   ![Adobe 帳戶](/help/main/c-intro/assets/adobe-account.png)

1. 在[!UICONTROL 帳戶]頁面上的&#x200B;**[!UICONTROL 慣用語言]**&#x200B;區段中，**[!UICONTROL 新增]**。
