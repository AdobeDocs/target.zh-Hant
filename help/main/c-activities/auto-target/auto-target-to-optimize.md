...
* 將[!UICONTROL Auto-Target]和[!UICONTROL Automated Personalization]活動限製為4-6個位置，每個位置有4-6個選件。 由於位置與選件組合的體驗總數會增加，因此較大的設定可能會導致[!UICONTROL Visual Experience Composer]中的載入或編輯速度緩慢。
