...
## 在活動頁面上使用暫留[!UICONTROL 更多動作]圖示來編輯活動 {#section_29EE2ECA6B88473A8F9AC5600FFBB174}

1. 從&#x200B;**[!UICONTROL 活動]**&#x200B;頁面，按一下您要編輯的活動旁的&#x200B;**[!UICONTROL 更多動作]**&#x200B;圖示（![更多動作圖示](/help/main/assets/icons/MoreSmall.svg) ），然後按一下&#x200B;[!UICONTROL **編輯**]。

   [!DNL Target]在[!UICONTROL 視覺化體驗撰寫器] (VEC)中開啟活動，而您會看到[!UICONTROL 體驗]頁面（三步驟引導式工作流程的第一步）。

1. 視需要使用 [VEC 選項](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md)編輯活動。

1. 按一下&#x200B;**[!UICONTROL 下一步]**&#x200B;以前往下一個步驟，然後進行任何必要的編輯。

1. 前往&#x200B;**目標與設定**&#x200B;頁面時，您有以下選項：

   * **[!UICONTROL 儲存並關閉]：**&#x200B;按一下&#x200B;**[!UICONTROL 儲存並關閉]**&#x200B;以儲存您的變更並顯示活動的[!UICONTROL 概覽]頁面。
   * **儲存：**&#x200B;按一下&#x200B;**[!UICONTROL 更多動作]**&#x200B;圖示（![更多動作圖示](/help/main/assets/icons/MoreSmallListVert.svg) ），然後選取&#x200B;**[!UICONTROL 儲存]**，以儲存您的變更並留在VEC中，讓您可以繼續變更。 等候儲存完成，之後再進行其他變更。 儲存完成後，VEC 會透過重新整理的變更重新載入。

## 從[!UICONTROL 活動]頁面按一下活動名稱以編輯活動 {#section_176180DAD17E40CEA441903F39E0AA1C}

1. 若要避免逐步執行工作流程，請從[!UICONTROL 活動]頁面中按一下所需的活動以開啟，從&#x200B;**[!UICONTROL 編輯活動]**&#x200B;下拉式清單中選取選項，然後選取所需的選項。

   * **編輯體驗：**&#x200B;帶您直接前往[!UICONTROL 體驗]頁面（三步驟引導式工作流程的第一步）。
   * **編輯鎖定目標**：帶您直接前往[!UICONTROL 鎖定目標]頁面（三步驟引導式工作流程的第二步）。
   * **[!UICONTROL 目標與設定]**：帶您直接前往[!UICONTROL 目標與設定]頁面（三步驟引導式工作流程中的第三個步驟）。
...
>[!NOTE]
>
>工作區是[!DNL Target Premium]解決方案所提供的[!UICONTROL 屬性和許可權]功能的一部分。 在沒有 [!DNL Target Standard] 授權的 [!DNL Target Premium] 中無法使用。
...
如果您的環境中啟用了[!UICONTROL 企業使用者許可權]，您可以將活動複製到相同的工作區或另一個工作區。 您目前無法將活動從一個工作區移動至另一個工作區。 若要將活動複製到另一個工作區，請從[!UICONTROL 活動]頁面，按一下您要複製之活動旁的&#x200B;**[!UICONTROL 更多動作]**&#x200B;圖示（![更多動作圖示](/help/main/assets/icons/MoreSmall.svg)），然後按一下&#x200B;[!UICONTROL **複製**]。
...
>[!NOTE]
>
>如果您的環境未啟用[!UICONTROL 企業使用者許可權]功能，則在複製之前，所有活動都會以編輯模式開啟。

## 以草稿形式儲存活動 {#section_968CD7A63027432EBD8FAE3A0F7404C3}

[!UICONTROL 另存為草稿]功能已無法使用。 如需詳細資訊，請參閱[將篩選器套用至活動清單](/help/main/c-activities/activities.md#filters)下的&#x200B;*[!UICONTROL 狀態]*。

## 使用在[!DNL Recommendations Classic]中建立的舊版活動 {#classic}

[!UICONTROL 活動]清單顯示以各種來源建立的活動，包括[!DNL Recommendations Classic]。 使用在 [!DNL Recommendations Classic] 中建立的舊版活動時，以下是可供使用的動作:
