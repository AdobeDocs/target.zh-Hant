...
[!UICONTROL Goals & Settings]中的[!DNL Adobe Target]頁面是您指定活動目標相關資訊的位置。
...
[!UICONTROL Advanced Settings]頁面的[!UICONTROL Goals & Settings]區段可讓您設定進階選項。

若要指定進階設定，請按一下&#x200B;**[!UICONTROL More]**&#x200B;區段中的![圖示（](/help/main/assets/icons/MoreSmallList.svg)更多圖示[!UICONTROL My Primary Goal] ），然後按一下&#x200B;**[!UICONTROL Advanced Settings]**。
