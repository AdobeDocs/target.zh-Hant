...
1. 在VEC的&#x200B;**[!UICONTROL 體驗]**&#x200B;頁面中，按一下&#x200B;**[!UICONTROL 新增體驗]**。
...
1. 完成體驗設計時，請按一下&#x200B;**[!UICONTROL 儲存]**。

## 重新命名體驗

1. 按一下[!UICONTROL A/B測試]或[!UICONTROL 體驗鎖定目標] (XT)活動之體驗上的&#x200B;**[!UICONTROL 重新命名體驗]**&#x200B;圖示，將體驗命名為新的名稱。
...
1. 按一下[!UICONTROL A/B測試]或[!UICONTROL 體驗鎖定目標] (XT)活動之體驗上的&#x200B;**[!UICONTROL 更多]**&#x200B;圖示（垂直省略符號）圖示，然後按一下&#x200B;**[!UICONTROL 重新導向至URL]**。
...
您可以複製[!UICONTROL A/B測試]中的體驗，不必從頭重新建立體驗，即可進行微幅變更。
...
以下影片提供有關使用[!UICONTROL 視覺化體驗撰寫器]選項的資訊。 (7:17)
