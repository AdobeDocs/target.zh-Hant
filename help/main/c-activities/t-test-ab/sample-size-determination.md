...
在[!DNL Adobe Target]中成功的[!UICONTROL A/B Test]活動需要足夠的訪客（樣本大小）來提高轉換率。 您如何知道執行A/B測試的時間長度？ 本文包含有關[!UICONTROL Auto-Allocate]活動與[!UICONTROL Adobe Target]樣本大小計算器的資訊，可協助您確保您的活動具有足夠的訪客來達成您的目標。
