---
keywords: AB;A/B;AB...n；錯誤；錯誤；錯誤；錯誤；錯誤；必損；重要性；贏家；統計差異；統計功率；流量分配；分配；
description: 瞭解如何避免公司在Adobe中執行A/B測試時遇到的最常見的錯誤和錯誤 [!DNL Target] 和其他測試解決方案。
...
A/B測試 [!DNL Adobe Target] 構成了大多數數字營銷優化計畫的支柱，幫助營銷人員為其訪問者和客戶提供優化且有針對性的體驗。 本節概述了公司在執行A/B測試時可能遇到的十個最重大的陷阱。 其中也包括避免這些問題的方式，使您的公司可透過其測試成果達到更高的 ROI，並在其報告的 A/B 測試結果中擁有更高的可信度。

## 皮特福1:忽略意義層次的影響 {#section_55F5577A13C6470BA1417C2B735C6B1D}
...
## 皮特福爾2:宣佈多個優惠test的贏家，但無統計顯著差異 {#section_FA83977C71DB4F69B3D438AF850EF3B6}
...
## 皮特福爾3:忽略統計力的影響 {#section_0D517079B7D547CCAA75F80981CBE12A}
...
## 第4步：使用單尾test {#section_8BB136D1DD6341FA9772F4C31E9AA37C}
...
## 皮特福爾5:監視test {#section_EA42F8D5967B439284D863C46706A1BA}
...
## 皮特福爾6:提前阻止test {#section_DF01A97275E44CA5859D825E0DE2F49F}
...
## 皮特福爾7:在測試期間更改流量分配 {#allocation}

我們建議您不要更改測試期間的流量分配百分比，因為這會扭曲您的test結果，直到資料正常化。
例如，假設您有A/BTest活動，其中80%的流量分配給Experience A（控制項）,20%的流量分配給Experience B。在測試期間，您將每個體驗的分配更改為50%。 幾天後，您將流量分配更改為100%以獲得B體驗。

在此方案中，如何為用戶分配體驗？

如果您將經驗B的分配分解人工更改為100%，則最初分配給經驗A（控制項）的訪問者將保留在最初分配的經驗（經驗A）中。 流量分配的變化只影響新進入者。

如果要更改百分比或極大地影響訪問者進入每種體驗的流量，建議您建立新活動或複製該活動，然後編輯流量分配百分比。

如果您在測試期間更改不同體驗的百分比，則資料需要幾天才能正常化，尤其是當許多購買者返回訪問者時。
另一個示例是，如果A/BTest的流量分配被分解為50/50，然後將分解更改為80/20，則在更改後的頭幾天，結果可能看起來有偏差。 如果平均轉換時間較長，即需要幾個小時甚至幾天的時間才能進行購買，則這些延遲的轉換可能會影響您的報告。 所以，在第一次體驗中，從50%到80%，平均轉換時間是兩天，只有50%的人在test的第一天轉換，儘管今天80%的人開始轉換。 這讓轉化率看上去一落千丈，但80%的遊客花兩天時間轉化後，轉化率將再次恢復正常。

## 皮特福爾8:不考慮新奇效應 {#section_90F0D24C40294A8F801B1A6D6DEF9003}
...
## 皮特福爾9:不考慮代價期間之差異 {#section_B166731B5BEE4E578816E351ECDEA992}
...
## 皮特福爾十：使用不反映業務目標的指標 {#section_F0CD6DC7993B4A6F9BEEBB31CD1D9BEE}
...
## 結論：通過識別和繞過陷阱，成功完成A/B測試 {#section_54D33248163A481EBD4421A786FE2B15}
