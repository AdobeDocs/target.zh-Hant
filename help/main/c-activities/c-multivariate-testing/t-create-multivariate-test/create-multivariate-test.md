...
1. （視條件而定）若要將一或多個體驗從活動中排除，請按一下&#x200B;**[!UICONTROL 管理內容]**&#x200B;圖示（ ![管理體驗圖示](/help/main/assets/icons/Experience.svg)）以顯示[!UICONTROL 管理體驗]對話方塊。

1. （視條件而定）在[!UICONTROL 管理體驗]對話方塊中，按一下您要排除的體驗旁的&#x200B;**[!UICONTROL 更多動作]**&#x200B;圖示（![更多動作圖示](/help/main/assets/icons/MoreSmallList.svg)），然後按一下&#x200B;**[!UICONTROL 排除]**。
