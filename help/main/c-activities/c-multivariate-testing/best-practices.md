...
description: 瞭解如何改善效能、避免問題，以及修正在 [!DNL Adobe Target]中建立和執行[!UICONTROL 多變數測試]活動時可能會發生的已知問題。
title: '[!UICONTROL 多變數測試]活動有何最佳作法？'
...
* 在[體驗效能報表](/help/main/c-reports/multivariate-test-reports/experience-performance-report.md)中，使用[!UICONTROL 最佳5]與[!UICONTROL 最差5]篩選器顯示資料來進行決策。

  [!UICONTROL 全部]篩選器會使得您難以擷取想要的資訊，而且並非所有體驗都可以顯示在圖表中。 如果您想要檢視不在最佳或最差前五名之內的特定體驗，請使用[!UICONTROL 全部]篩選器。
