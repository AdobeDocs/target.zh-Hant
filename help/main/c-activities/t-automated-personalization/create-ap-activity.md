---
keywords: 自動個人化；ap
description: 瞭解如何使用[!UICONTROL Automated Personalization]建立[!UICONTROL Visual Experience Composer] (AP)活動。
