...
description: 瞭解如何Adobe [!DNL Target] 在Automated Personalization (AP)和自動鎖定目標活動中使用隨機森林演演算法。
title: How Do [!DNL Target] 使用隨機森林演演算法？
...
## Target的個人化演演算法如何使用隨機森林？ {#section_32FB53CAD8DF40FB9C0F1217FBDBB691}

**如何建立模型**

下圖彙總如何建立自動鎖定目標或自動個人化活動的模型:

![random_forest_flow圖片](assets/random_forest_flow.png)
