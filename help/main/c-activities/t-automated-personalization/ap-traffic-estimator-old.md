...
1. 在[!UICONTROL Automated Personalization]活動中，從[!UICONTROL 視覺化體驗撰寫器]的[!UICONTROL 體驗]頁面，按一下&#x200B;**[!UICONTROL 流量]**&#x200B;圖示。

   ![流量圖示](/help/main/c-activities/t-automated-personalization/assets/icon-traffic.png)

   [!UICONTROL 流量估算程式]開啟。 您可以再按一下&#x200B;**[!UICONTROL 流量]**&#x200B;來隱藏[!UICONTROL 流量估算程式]。
