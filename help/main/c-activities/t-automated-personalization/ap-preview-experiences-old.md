...
description: 瞭解如何使用[!UICONTROL 視覺化體驗撰寫器] (VEC)預覽 [!DNL Adobe Target] 中[!UICONTROL Automated Personalization] (AP)活動的每個體驗。
...
1. 按一下&#x200B;**[!UICONTROL 撰寫]**&#x200B;以返回[!UICONTROL 視覺化體驗撰寫器]，讓您可以進行任何其他變更，或按一下&#x200B;**[!UICONTROL 下一步]**&#x200B;以移至[!UICONTROL 鎖定目標]步驟。
