...
1. 按一下&#x200B;**[!UICONTROL Manage Content]**&#x200B;以設定可用的組合。
   ...
   >[!NOTE]
   >
   >雖然您可以在AP活動中建立最多30,000個體驗，但使用的體驗少於5,000個時，活動的執行效能最佳。 即使活動已啟用[!UICONTROL Disallow Duplicates]選項，此限制也會套用。
...
1. （視條件而定）按一下&#x200B;**[!UICONTROL Exclusion Groups]**&#x200B;以選擇要從活動中排除的任何元素組合。
   ...
   雖然您可以在 AP 測試中建立最多 30,000 個體驗，使用少於 10,000 相異體驗時，演算法的執行效能最佳。 即使活動已啟用[!UICONTROL Disallow Duplicates]選項，此限制也會套用。
