...
+ Target發行說明 {#release-notes}
   + {hide-from-toc}[Target公告和活動](/help/main/r-release-notes/target-announcements.md)
...
+ 管理 Target {#administer}
   ...
   + {hide-from-toc}[內容預先隱藏](administrating-target/content-pre-hiding.md)
   + [主機](administrating-target/hosts.md)
   + [環境](/help/main/administrating-target/environments.md)
   + [已加入允許清單的URL](administrating-target/allowlisted-urls.md)
...
+ Adobe Target MCP伺服器 {#mcp}
   + [概觀](c-integrating-target-with-mac/mcp/target-mcp.md)
   + [開始使用](c-integrating-target-with-mac/mcp/target-mcp-get-started.md)
   + [使用案例和逐步說明](c-integrating-target-with-mac/mcp/target-mcp-use-cases.md)
   + [MCP伺服器工具參考](c-integrating-target-with-mac/mcp/target-mcp-tools-reference.md)
...
+ 推薦 {#recommendations}
   ...
   + 活動 {#recommendations-activity}
      ...
      + {hide-from-toc}[預覽和啟動推薦活動](/help/main/c-recommendations/t-create-recs-activity/previewing-and-launching-your-recommendations-activity.md)
