...
![新應用程式通知](/help/c-target-mobile-app/c-mobile-visual-experience-composer/assets/manage-versions-notification-new.png)

可在[!UICONTROL 管理版本]對話方塊中手動新增及移除多個行動應用程式版本。

![管理版本對話方塊](/help/c-target-mobile-app/c-mobile-visual-experience-composer/assets/manage-versions-dialog.png)
