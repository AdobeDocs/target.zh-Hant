...
description: 收到電子郵件寄送的Adobe Experience Cloud加入邀請函後，管理員應執行Adobe [!DNL Target] 的第一個工作。
...
本文包含[!DNL Adobe Target]管理員在收到電子郵件所寄送[!DNL Adobe Experience Cloud]邀請時應採取的前幾個步驟。
