...
>[!NOTE]
>
>[!DNL at.js] 1.1 或更新版本提供回應 Token。回應 Token 不支援搭配 mbox.js 使用。
...
使用 [at. js自訂事件](/help/c-implementing-target/c-implementing-target-for-client-side-web/atjs-custom-events.md) 監聽mbox回應，並讀取回應Token。
