...
![活動設定頁面](/help/c-activities/t-experience-target/t-xt-create/assets/ab_settings-new.png)
...
![進階設定](/help/c-activities/t-experience-target/t-xt-create/assets/Menu_AdvancedSettings-new.png)
...
3. 將需要的量度從左窗格拖曳到右窗格，然後按一下「達到」來將設定在「達到」與「未達到」之間切換。
   ...
   ![新增量度相依性對話方塊](/help/c-activities/t-experience-target/t-xt-create/assets/add_dependency_reached-new.png)
