...
# ![高級](/help/assets/premium.png) 資料使用者 [!DNL Target] 機器學習算法
...
瞭解有關 [!DNL Target] 個性化算法，請參閱 [隨機森林算法](/help/c-activities/t-automated-personalization/algo-random-forest.md)。

## 預設 [!DNL Adobe Target] 屬性類別

下表顯示了由 [!UICONTROL Automated Personalization] 和 [!UICONTROL 自動目標] 預設情況下的活動，不配置任何 [!DNL Target] 或 [!DNL Adobe] 解決方案，以及用於在 [個性化透視報告](/help/c-reports/c-personalization-insights-reports/personalization-insights-reports.md#concept_A897070E1EDC403EB84CFB7A6ECAD767)。 您可以隨時擴大輸入的資料。若要進一步瞭解如何上傳其他資料，請參閱 [正在上載 [!DNL Target] 個性化算法](/help/c-activities/t-automated-personalization/uploading-data-for-the-target-personalization-algorithms.md)。
...
阻止功能類別 [!DNL Target] 機器學習算法，聯繫 [Adobe客戶關懷](/help/cmp-resources-and-contact-information.md#section_CC8B206F58D6495C9372D5C0D4055CF6) 並使用上面提供的「系統前置詞」指定要阻止的功能類別。

阻止一個或多個特定功能 [!DNL Target] 機器學習算法，聯繫 [Adobe客戶關懷](/help/cmp-resources-and-contact-information.md#section_CC8B206F58D6495C9372D5C0D4055CF6) 並使用以下提供的系統名稱指定應阻止的特定功能名稱。 下列章節包含有關各種資料類型的詳細資訊，包括屬性名稱、說明和值範例。
