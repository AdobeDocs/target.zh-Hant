---
title: 設定逐步推出的功能
description: 瞭解如何在Flags中為功能標幟設定以百分比為基礎的逐步推出。
...
當您設定轉出百分比（例如25%）時，已定義對象的該百分比會公開給功能。 轉出百分比為&#x200B;**必要**，預設為&#x200B;**100%** （此功能提供給整個相符的對象）。 您可以以&#x200B;**1%的增量**&#x200B;調整它。 剩餘的百分比會放置於接收預設體驗的&#x200B;**控制群組**&#x200B;中。

您可以隨時間增加或減少百分比，以展開或縮減轉出。 將百分比降低至0%實際上會在不刪除標幟的情況下關閉對象中每個人的功能。
