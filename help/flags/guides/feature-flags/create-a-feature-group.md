...
>[!IMPORTANT]
>
>當您從功能群組&#x200B;**移除**&#x200B;功能標幟時，該標幟會回到&#x200B;**已停用**&#x200B;狀態，且其對象為&#x200B;**未**&#x200B;已還原 — 將其視為新的標幟。 群組內的&#x200B;**已停用**&#x200B;旗標一律評估為`false`。 啟用功能群組&#x200B;**不會**&#x200B;啟用其成員旗標；請明確啟用每個旗標。
>
>功能群組是&#x200B;**管理層**。 在執行階段，您一律會在&#x200B;**功能（旗標）層級**&#x200B;進行評估，絕不會是在群組層級；回應會包含使用者所屬的變體。
