...
+ 概念 {#concepts}
  + [什麼是功能標幟](concepts/what-is-a-feature-flag.md)
  + [可啟用和停用功能的功能標幟](concepts/feature-flags-to-enable-disable-features.md)
...
+ 整合旗標 {#integrate}
  + [在應用程式中整合標幟](guides/integrate/integrating-in-your-app.md)
  + [啟動指南](guides/integrate/startup-guide.md)
...
+ 對象條件 {#audience}
  ...
  + [複雜的受眾規則](guides/audience/complex-rules.md)
  + [建立您的內容屬性](guides/audience/creating-your-context-attributes.md)
  + [建立和使用規則集](guides/audience/creating-and-using-rule-sets.md)
+ 匯入功能標幟 {#import}
  + [匯入功能標幟](guides/cross-environment/import-feature-flags.md)
+ 整合指南 {#sdk-releases}
  + [Android擴充功能整合指南](guides/sdk-releases/android/android-extension-integration-guide.md)
  + [iOS擴充功能整合指南](guides/sdk-releases/ios/ios-extension-integration-guide.md)
  + [Web擴充功能整合指南](guides/sdk-releases/web/web-extension-integration-guide.md)
