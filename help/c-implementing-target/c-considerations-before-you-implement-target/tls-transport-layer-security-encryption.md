...
>[!NOTE]
>
>在 2019 年 2 月 20 日，EMEA、日本和 APAC 區域中的 Adobe Target 基礎架構已升級，不再從使用較舊裝置或不支援 TLS 1.1 或更新版本的網頁瀏覽器的一般使用者收集資料。這項升級預計在 **2019 年 4 月 1 日**&#x200B;於北美區域推行。轉移至 TLS 1.2 可改善安全性。請務必詳閱詳細資訊，並與 IT 團隊針對變更進行規劃，以順利轉移。
