...
1. 選取頁面類型。
   ...
   * 感謝頁面
   * 其他
   ![選取「頁面類型」選項](/help/c-recommendations/t-create-recs-activity/assets/Menu_PageType.png)
...
1. Select a [design](/help/c-recommendations/c-design-overview/design-overview.md).
   ...
   ![選取「設計」對話方塊](/help/c-recommendations/t-create-recs-activity/assets/Card_SelectDesign.png)
...
1. 在流程圖表中檢閱您的 [!DNL Recommendations] 活動，並進行任何必要的變更。
   ...
   ![Recommendations流程圖](/help/c-recommendations/t-create-recs-activity/assets/SCRN_Workflow.png)
